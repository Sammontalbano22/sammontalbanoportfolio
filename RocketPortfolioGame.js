...
for (let i = 0; i < 100; i++) {
  ...
  // Rocket Body
  gameCtx.fillStyle = "#FFD700"; // bright yellow
  gameCtx.beginPath();
  ...
  // Nose Cone
  gameCtx.fillStyle = "#FF4500"; // orange-red
  gameCtx.beginPath();
  gameCtx.moveTo(-rocket.w / 2, -rocket.h / 2);
  ...
  // Side Fins
  gameCtx.fillStyle = "#FF6347"; // tomato red
  gameCtx.beginPath(); // left fin
  gameCtx.moveTo(-rocket.w / 2, rocket.h / 2);
  gameCtx.lineTo(-rocket.w / 1.2, rocket.h / 1.8);
  gameCtx.lineTo(-rocket.w / 2, rocket.h / 3);
  gameCtx.closePath();
  gameCtx.fill();
  ...
  // Window
  gameCtx.fillStyle = "#87CEEB"; // sky blue
  gameCtx.beginPath();
  gameCtx.arc(0, -rocket.h / 3, rocket.w / 4, 0, Math.PI * 2);
  gameCtx.fill();

  // Exhaust flame (optional flicker)
  if (!moonReached) {
    const flameHeight = Math.random() * 10 + 10;
    gameCtx.fillStyle = "#FF8C00"; // dark orange
    gameCtx.beginPath();
    gameCtx.moveTo(-rocket.w / 4, rocket.h / 2);
    gameCtx.lineTo(0, rocket.h / 2 + flameHeight);
    gameCtx.lineTo(rocket.w / 4, rocket.h / 2);
    gameCtx.closePath();
    gameCtx.fill();
  }
